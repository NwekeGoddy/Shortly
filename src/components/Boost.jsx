...
function Boost() {
    return ( 
        ...
        style={{ backgroundImage: `url(${ShortenDesktop})` }}>
            <h1 className="text-lg font-bold md:text-2xl">Boost your links today</h1>
            <button className="my-3 px-5 py-2 border rounded-full bg-Cyan hover:bg-cyan-500 text-white hover:text-cyan-100">
            Get Started
          </button>
        </section>
     );
